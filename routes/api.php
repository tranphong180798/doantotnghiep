...
Route::get('/listSuggest',[WebController::class,'index1']);
Route::get('res-detail/{id}', [WebController::class,'getDetail1']);
Route::post('comment/createApi', 'CommentController@createApi');
