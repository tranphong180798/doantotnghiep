...
@section('script')
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDAYtT2LR1PwKzvVVWZKf6iduU5pc-Dl1Q&callback=initMapToChoose" async
        defer>
    </script>
    <script defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDAYtT2LR1PwKzvVVWZKf6iduU5pc-Dl1Q&callback=initMap2">
    </script>
@endsection
