...
class WebController extends Controller
{
    ...
    public function getDetail1(Request $request){
        ...
        try {
           $user_location = [
            ...
            if(!empty($res)){
                ...
                $url = 'https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=' . $origin . '&destinations=' . $destination . '&key=AIzaSyDAYtT2LR1PwKzvVVWZKf6iduU5pc-Dl1Q';
                $curl = curl_init();
